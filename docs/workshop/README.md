...
- Use [cli-command-showcase.md](cli-command-showcase.md) as the command reference for Antigravity CLI flags, slash commands, shortcuts, and settings.
...
- Use the CLI command showcase as the reusable command reference, especially during or after branch `06-command-showcase`.
